      ...
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
        ...
        <div className='text-3xl font-semibold text-violet-700'>
         ...
         <div className='flex flex-col items-start gap-8 lg:flex-row'>
          ...
          <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-xl px-6 py-8'>
            ...
            <form className='flex flex-col gap-y-4'>
              ...
              <textarea className='border border-gray-400 focus:border-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400' placeholder='Message' defaultValue="Hello, I'm interested in modern apartment."></textarea>
              <div className='flex gap-x-2'>
                ...
                <button className='border border-violet-700 text-violet-800 hover:border-violet-500 hover:text-violet-500 rounded p-4 text-sm w-full transition'>Call</button>
              </div>
            </form>
          </div>
         </div>
